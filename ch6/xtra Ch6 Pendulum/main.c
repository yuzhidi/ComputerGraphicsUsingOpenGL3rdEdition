/*  FATAL FX' Pendulum (C) 1995, 1998 Fatal FX
 *  Version 1.4
 *  Special thanks to Lazzy
 *  How to compile on a SGI (GLUT is needed):
 *  cc -o pendulum pendulum.c -lglut -lGLU -lGL -lXmu -lXext -lX11 -lm
 */
...
int main(int argc, char** argv)
{
    ...
    glutCreateWindow("Pendulum [www.fatalfx.com]");
    init();
