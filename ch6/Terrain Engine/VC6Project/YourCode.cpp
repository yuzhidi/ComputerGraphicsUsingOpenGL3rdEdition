...
// vars
static RTexture			 l_texTerrain[2];
...
bool appInit()	// Called right after the window is created, and OpenGL is initialized.
{
	...
	// load some textures
	LoadTexture(l_texTerrain+0, "../data/terrain-texture3.bmp");
	LoadTexture(l_texTerrain+1, "../data/detail.bmp");
...
//	l_pTerrain = new Terrain("../data/crytek-heightmap.bmp");
	...
	l_pTerrain->SetTextures(&l_texTerrain[0], &l_texTerrain[1],	// ground 1/2
							l_texSkyBox,						// skybox
...
void appShutdown() // Called right after the window is destroyed.
{
	...
	l_texTerrain[0].Toast();
	l_texTerrain[1].Toast();
